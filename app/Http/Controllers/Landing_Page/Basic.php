...
class Basic extends Controller
{
    ...
    public function plans()
    {
        ...
        $plan_id = session('plan_id');
        if ($plan_id == '0') {
            return view('landing_pages.plans')->with(compact( 'title'));
        }
        else{
            return view('home_pages.home');
        }
    ...
    public function login()
    {
        ...
        $plan_id = session('plan_id');
        if ($plan_id == '0') {
            return view('landing_pages.login')->with(compact( 'title'));
        }
        else{
            return view('home_pages.home');
        }
    ...
    public function register()
    {
        ...
        $plan_id = session('plan_id');
        if ($plan_id == '0') {
            return view('landing_pages.register')->with(compact('all_countries', 'title'));
        }
        else{
            return view('home_pages.home');
        }
