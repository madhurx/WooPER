...
<html lang="en">
  ...
  <body>
    <!--  NAV START -->
    <nav
      class="navbar navbar-light bg-white sticky-top navbar_getstarted navbar-expand-sm"
    >
      ...
      <div class="row min-vh-100">
        ...
        <div class="col-2 bg-black">
          <div class="row p-3 w-100">
            <div
              class="col py-4 text-white"
              style="width: 202px; position: fixed; top: 60"
            >
              <!--  -->
              ...
              <ul style="list-style: none">
                ...
                <li class="nav-item my-3">
                  ...
                  <div class="collapse" id="collapseExample">
                    <div class="">
                      <ul style="list-style: none">
                        <li class="my-1"><i class="fa-solid fa-video"></i>&nbsp;Customers</li>
                        <li class="my-1"><i class="fa-regular fa-lightbulb"></i>&nbsp;Plans</li>
                        <li class="my-1"><i class="fa-solid fa-house-user"></i>&nbsp;Homepage</li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li class="nav-item my-3">
                    ...
                    <div class="collapse" id="collapseExample2">
                      <div class="">
                        <ul style="list-style: none">
                          <li class="my-1"><i class="fa-solid fa-rss"></i>&nbsp;Blog</li>
                          <li class="my-1"><i class="fa-solid fa-file-pdf"></i>&nbsp;Notes</li>
                          <li class="my-1"><i class="fa-solid fa-file-audio"></i>&nbsp;Podcasts</li>
                          <li class="my-1"><i class="fa-solid fa-video"></i>&nbsp;Videos</li>
                        </ul>
                      </div>
                    </div>
                  </li>
        ...
        <div class="col-10 px-3">
                        ...
                        <div class="row-cols-1 row justify-content-center align-items-center text-white py-4 content_navbar">
                            <div class="col">
                                <nav class="navbar navbar-expand-sm bg-black navbar-light">
                                    <div class="container-fluid">
                                        <ul class="navbar-nav">
                                            <li class="nav-item">
                                                <a class="nav-link " href="#" role="button"> Create Instructor</a>
                                            </li>
                                            <li class="nav-item">
    ...
    <!-- FONT AWESOME START-->
    <script
      src="https://kit.fontawesome.com/3d0e7e114f.js"
      crossorigin="anonymous"
    ></script>
    <!-- FONT AWESOME END-->
