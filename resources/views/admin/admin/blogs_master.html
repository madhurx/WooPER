                ...
                <li class="nav-item my-3">
                  ...
                  <div class="collapse" id="collapseExample">
                    <div class="">
                      <ul style="list-style: none">
                        <li class="my-1">
                          <i class="fa-solid fa-video"></i>&nbsp;Customers
                        </li>
                        <li class="my-1">
                          <i class="fa-regular fa-lightbulb"></i>&nbsp;Plans
                        </li>
                        <li class="my-1">
                          <i class="fa-solid fa-house-user"></i>&nbsp;Homepage
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="collapse" id="collapseExample2">
                    <div class="">
                      <ul style="list-style: none">
                        ...
                        <li class="my-1">
                          <i class="fa-solid fa-file-audio"></i>&nbsp;Podcasts
                        </li>
                        <li class="my-1">
            ...
            <div class="col">
              ...
              >
                ...
                <div class="mb-3">
                  ...
                  <img
                    src="{{ URL::asset('uploaded_images/Instructor_PFP/' . $edit->instructor_pfp) }}"
